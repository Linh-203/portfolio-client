...
const introduction = {
  text: [
    ...
    'Hiện tại, tôi đang là sinh viên kì 5 tại trường FPT Polytechnic. ',

    'Tôi bắt đầu học lập trình từ năm nhất. Và ước mơ của tôi là trở thành Frontend Developer ',

    'Ngoài việc học tập trên trường thì tôi thường học thêm trên F8 Fullstack và trên các kênh Youtube như evondev, easy frontend, ...',
  ],
};
